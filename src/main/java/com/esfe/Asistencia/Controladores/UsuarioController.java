...
public class UsuarioController {
    @Autowired
    private IGrupoService usuarioService;

    @Autowired
    private IDocenteService rolService;
    ...
    public String index(Model model, @RequestParam("page") Optional<Integer> page, @RequestParam("size") Optional<Integer> size){
        ...
        Page<UsuarioService> usuarios = usuarioService.obtenerTodosPaginados(pageable);
    ...
    @GetMapping("/create")
    public String create(UsuarioService usuario, Model model){
